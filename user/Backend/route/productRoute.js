...
const { addProduct, sendNotification, allProducts, updateProduct, deleteProduct, fetchSingleProduct, getSuggestions, searchProduct} = require("../controller/productController")
